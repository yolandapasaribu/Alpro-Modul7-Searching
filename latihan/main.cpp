...
int sequential_search(string data[],int panjang,string key){//membuat fungsi sequential_search dengan paramater data,panjang,key
...
{
    string data[]={"neptunus","saturnus","mars","yupiter","bumi","venus","merkurius","venus","merkurius","uranus"};//membuat array data yang memiliki nilai 1,0,3,2,5,7,9,11
    string key;
    cout<<"Mau cari apa : ";
    cin>>key;
